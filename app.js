...
function setupForkButton() {
    if (unr == "HansakaBro") {
        document.getElementById("fork").innerHTML = `<a class="github-button" href="https://github.com/HansakaBro" data-color-scheme="no-preference: dark_dimmed; light: dark_dimmed; dark: dark_dimmed;" data-size='large' aria-label="Follow @HansakaBro on GitHub">Follow @HansakaBro</a>`;
    } else {
